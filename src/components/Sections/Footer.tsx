    ...
    <section className="footer relative w-full px-5 py-6 text-white lg:mt-40 lg:px-20">
      ...
      <div className="container mx-auto space-y-6 divide-y divide-gray-400 divide-opacity-50 px-6 md:space-y-12 lg:mt-20 lg:px-44">
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          <div className="text-md flex flex-col self-center text-center md:block md:space-x-6 lg:col-start-1">
          ...
          <div className="flex justify-center space-x-4 pt-4 lg:col-end-13 lg:pt-0">
            ...
            <a
              ...
              title="Twitter"
              className="flex h-10 w-10 items-center justify-center rounded-full dark:bg-violet-400 dark:text-gray-900">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="h-10 w-10">
